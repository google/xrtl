...
#ifndef XRTL_BASE_ARENA_H_
#define XRTL_BASE_ARENA_H_
...
// parsing, per-frame write-once/read-once data buffers, etc.
//
// Usage:
//   Arena arena;
...
class Arena {
 public:
  ...
  static constexpr size_t kBlockOverhead = 16;
