...
// bool VKDevice::AdoptCurrentContext() {
...
void VKDevice::QuerySupportedPixelFormats(
    Features::PixelFormats* pixel_formats) {
  // pixel_formats->packed_depth_stencil = GLAD_GL_OES_packed_depth_stencil ==
  // 1; pixel_formats->bc1_2_3 = GLAD_GL_EXT_texture_compression_s3tc == 1;
