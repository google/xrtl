...
// Describes a single binding slot within a ResourceSet.
// Each of these values maps to a BindingSlot defined in a ResourceSetLayout.
struct BindingValue {
  ...
  BindingValue(absl::Span<const BindingValue> elements)  // NOLINT
